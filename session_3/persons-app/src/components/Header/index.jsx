...
function Header() {
  return (
    <nav className="navbar navbar-icon-top navbar-expand-lg navbar-dark bg-dark">
      <a className="navbar-brand" href="#nowhere">Navbar</a>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav mr-auto">
          <li className="nav-item active">
            <a className="nav-link" href="#nowhere">
          ...
          <li className="nav-item">
            <a className="nav-link disabled" href="#nowhere">
              <i className="fa fa-envelope-o">
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
              <a className="dropdown-item" href="#nowhere">Action</a>
              <a className="dropdown-item" href="#nowhere">Another action</a>
              <div className="dropdown-divider"></div>
              <a className="dropdown-item" href="#nowhere">Something else here</a>
            </div>
          </li>
        </ul>
